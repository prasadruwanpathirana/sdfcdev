...
Contact.prototype.isValid = function() {
    ...
    return this.FirstName() != this._orig["FirstName"] || this.LastName() != this._orig["LastName"] || this.Title() != this._orig["Title"] || this.Email() != this._orig["Email"] || this.Phone() != this._orig["Phone"];
};
