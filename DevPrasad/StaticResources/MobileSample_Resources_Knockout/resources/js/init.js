...
function sammyRoutes(koApp) {
    ...
    var sammyApp = Sammy(function () {
        ...
        // Login (i.e set sessionId) and show contacts list view
        var showContactsList = function () {
                koApp.setViewModelByRoute("/contacts");
                koApp.currentViewModel.login();
                this.render(absolutePath + '/partials/contact/MobileSample_koContactList').replace('#mainContainer');          
        };

        this.get('/', showContactsList);
        this.get('/apex/MobileSample_koIndex', showContactsList);
        ...
        this.get('/contacts', showContactsList);
